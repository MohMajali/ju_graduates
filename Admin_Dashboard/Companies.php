...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO companies (name, image) VALUES (?,?) ");

        $stmt->bind_param("ss", $company_name, $file);
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
            alert ('A New Company Has Been Added Successfully !');
       </script>";
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
<?php
$sql1 = mysqli_query($con, "SELECT * from companies ORDER BY id DESC");
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      <th scope="row"><?php echo $company_id ?></th>
                      ...
                      <td>
                        <a href="./Edit-Company.php?company_id=<?php echo $company_id ?>" class="btn btn-success"
                          >Edit</a
                        >
                        <?php if ($active == 1) {?>

                          <a href="./DeleteOrRestoreCompany.php?company_id=<?php echo $company_id ?>&&isActive=<?php echo 0 ?>" class="btn btn-danger">Delete</a>

                          <?php } else {?>

                            <a href="./DeleteOrRestoreCompany.php?company_id=<?php echo $company_id ?>&&isActive=<?php echo 1 ?>" class="btn btn-primary">Restore</a>
