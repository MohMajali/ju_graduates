...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
            alert ('A New Department Has Been Added Successfully !');
       </script>";
...
<html lang="en">
  <head>
    ...
    <title>Departments - JU-GRADUATES</title>
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      <th scope="row"><?php echo $department_id ?></th>
                      <td><?php echo $name ?></td>
                      <td><?php echo $created_at ?></td>
                      <td>
                        <a href="./Edit-Department.php?department_id=<?php echo $department_id ?>" class="btn btn-success"
                          >Edit</a
                        >

                        <?php if ($active == 1) {?>

<a href="./DeleteOrRestoreDep.php?department_id=<?php echo $department_id ?>&&isActive=<?php echo 0 ?>" class="btn btn-danger">Delete</a>

<?php } else {?>

  <a href="./DeleteOrRestoreDep.php?department_id=<?php echo $department_id ?>&&isActive=<?php echo 1 ?>" class="btn btn-primary">Restore</a>
