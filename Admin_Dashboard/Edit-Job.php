...
if (!$A_ID) {
    ...
    $sql2 = mysqli_query($con, "select * from jobs where id='$job_id'");
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("UPDATE jobs SET name = ? WHERE id = ? ");

        $stmt->bind_param("si", $job_name, $job_id);
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form method="POST" action="./Edit-Job.php?job_id=<?php echo $job_id?>">
                ...
                <input type="hidden" name="job_id" value="<?php echo $job_id ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="text" name="name" value="<?php echo $jobName?>" class="form-control" id="inputText" />
                    </div>
                  </div>
                  <div class="text-end">
