...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO jobs (name) VALUES (?) ");
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
            alert ('A New Job Has Been Added Successfully !');
       </script>";
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      ...
                      <td>
                        <a href="./Edit-Job.php?job_id=<?php echo $job_id ?>" class="btn btn-success"
                          >Edit</a
                        >

                        <?php if ($active == 1) {?>

<a href="./DeleteOrRestoreJob.php?job_id=<?php echo $job_id ?>&&isActive=<?php echo 0 ?>" class="btn btn-danger">Delete</a>

<?php } else {?>

  <a href="./DeleteOrRestoreJob.php?job_id=<?php echo $job_id ?>&&isActive=<?php echo 1 ?>" class="btn btn-primary">Restore</a>
